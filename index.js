...
document.addEventListener('DOMContentLoaded', function() {
  ...
  console.log("I specialize in modern Javascript and ReactJS");
  console.log("I'm currently a 3rd year student in Maharaja Agrasen Institute Of Technology");
  console.log("%canujarora0502@gmail.com", "font-size: 20px; color: purple;");
  console.log("%c(+91)-9711379962", "font-size: 19px; color: #AC02AC;");
})
